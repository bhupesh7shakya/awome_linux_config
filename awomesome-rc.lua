...
awful.spawn.with_shell("feh --bg-scale /home/user/Downloads/mob.png")
...
-- awful.spawn.with_shell("mattermost-desktop")
...
awful.keyboard.append_global_keybindings({
        ...
        -- Volume control using pamixer or pactl
    awful.key({}, "XF86AudioRaiseVolume", function ()
        awful.spawn("pamixer --increase 5")   -- Increases volume by 5%
    end, {description = "increase volume", group = "volume"}),

    awful.key({}, "XF86AudioLowerVolume", function ()
        awful.spawn("pamixer --decrease 5")   -- Decreases volume by 5%
    end, {description = "decrease volume", group = "volume"}),

    awful.key({}, "XF86AudioMute", function ()
        awful.spawn("pamixer --toggle-mute")   -- Toggles mute/unmute
...
awful.key({ }, "XF86MonBrightnessDown", function ()
    ...
    {description = "clipboard", group = "copypast"}),
